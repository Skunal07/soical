        ...
        <div class="col-lg-8 col-md-10">
          <div class="forgot">
              ...
              <ol class="list-unstyled">
                  <li><span class="text-primary text-medium"></span>Enter your password.</li>
            <li><span class="text-primary text-medium"></span>Do not share your password</li>
            <li><span class="text-primary text-medium"></span>We do not save your passwords</li>
          </ol>
